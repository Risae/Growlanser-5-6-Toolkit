...
def ScriptExtractor():
    ...
    def ScriptPointerExtractor(inputfile, comments, tablefile):
...
#END BLOCK""")
    ...
    for filename in dir_list:
        ...
        try:
            ...
            ScriptPointerExtractor(inputFile, commentsOption, abcdeScriptTableFile)
...
def ByteCodeExtractor():
    ...
    def ByteCodePointerExtractor(inputfile, tablefile):
    ...
    for filename in dir_list:
        ...
        ByteCodePointerExtractor(inputFile, abcdeByteCodeTableFile)
